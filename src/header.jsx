        ...
        <div>
            ...
            <div className={"w-full shadow-lg bg-slate-200 flex flex-col gap-2 justify-center p-5"}>
                <div className={"text-center text-slate-700 flex justify-center"}>
                    <p className={"text-wrap w-3xl"}>Below is a timeline of actions taken by the trump administration
...
function EggMeter(props) {
    return <EggSvg className={"p-2 rounded-full border h-10 w-10"} style={{ backgroundColor: CalculateColor(props.value) }} />
}
